...
`На основі наданих файлів коду, тобі треба зробити повну документацію для RESTFull API у форматі json, для postman. Мають бути прописані всі endpoints, запити до них і відповіді, статус-кодів, в усіх description має бути повноцінний опис endpoint статус коди, що приймає, що віддає, статус коди ...... `
